...
cloudinary_dataset = 'http://res.cloudinary.com/ftsmukm/image/upload/gpk/dataset'
cloudinary_tmp = 'http://res.cloudinary.com/ftsmukm/image/upload/gpk/tmp'
...
class SignUpForm(QFrame):
    ...
    def initUI(self):
        ...
        self.uname = ''
        self.unameLbl = QLabel('Matric Number')
...
class GenerateDatasetTab(QWidget):
    ...
    def uploadDataset(self):
        ...
        if i==1:
            self.messageLbl.setText('Error: Some error while uploading to cloudnary, Please try later!TEST1')
